...
const telegram = 'https://t.me/WERFDASH'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/keps nub';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@hyspike.gt')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@hyspike.gt`)
})
...
else if (text == 'sisijxjssi')
{
conn.sendMessage(id, tambahan.hai ,MessageType.text);
}
else if (text == 'as2p2lkekdksum')
{
conn.sendMessage(id, tambahan.ass ,MessageType.text);
}
else if (text == 'brsuieiwjeiwho')
{
conn.sendMessage(id, tambahan.bro ,MessageType.text);
}
else if (text == '102892010jdosp')
{
conn.sendMessage(id, tambahan.p ,MessageType.text);
}
else if (text == 't262829hdiwkeest')
{
  conn.sendMessage(id, tambahan.test, MessageType.text);
}
else if (text == 'H22929od0wkALO')
{
conn.sendMessage(id, tambahan.halo ,MessageType.text);
}
else if (text == 'Hal202299ejeo')
{
conn.sendMessage(id, tambahan.halo ,MessageType.text);
}
else if (text == 'H28dhwai2882je')
{
conn.sendMessage(id, tambahan.hai ,MessageType.text);
}
else if (text == 'A292oxnlqowpalaikum')
{
conn.sendMessage(id, tambahan.ass ,MessageType.text);
}
else if (text == 'Beleokdkeoemxro')
{
conn.sendMessage(id, tambahan.bro ,MessageType.text);
}
else if (text == '2j2iejd92jeiP')
{
conn.sendMessage(id, tambahan.p ,MessageType.text);
}
else if (text == 'Teoeopskwpwmxt')
{
  conn.sendMessage(id, tambahan.test, MessageType.text);
}
else if (text == 'o303lwpwpncnwAI')
{
conn.sendMessage(id, tambahan.hai ,MessageType.text);
}
else if (text == 'ASSepeplepe022i7zo01664M')
{
conn.sendMessage(id, tambahan.ass ,MessageType.text);
}
else if (text == 'BR30164010mxowO')
{
conn.sendMessage(id, tambahan.bro ,MessageType.text);
}
else if (text == 'TE10376202oenxoskSST')
{
  conn.sendMessage(id, tambahan.test, MessageType.text);
}
// Fitur
...
************************************
   ...
   {
    var items = ["ullzang girl", "cewe cantik", "hijab cantik", "korean girl", "remaja cantik", "cewek korea", "cewek jepang","cewek jadi jadian"];
   ...
   {
    var items = ["cowok jelek","cowo ganteng", "cogan", "korean boy", "chinese boy", "japan boy", "cowok indo ganteng", "cowok korea"];
